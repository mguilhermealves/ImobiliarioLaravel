...
<div class="row detalhes-produto-rfq  padding-left-20 padding-top-30">
  <div class="col-xs-2 col-sm-2 col-lg-2 col-lg-2 text-center imagem-produto">
    <img src="{{$resposta->rfq->imagem1 ?? assets('sistema/images/avatar.png')}}" alt="" />
  </div>
  <div class="col-xs-10 col-sm-10 col-lg-10 col-lg-10 padding-left-15">
    <div class="row">
      <h3 class="text-black text-24-pt bold">{{$resposta->rfq->empresa->usuario->fullName}} / {{$resposta->rfq->empresa->nome}}</h3>
    </div>
...
<div class="row margin-top-20">
  ...
  <div class="col-lg-8 padding-left-20 main-mensagem relative" id="{{$resposta->mensagem->id ?? 0}}" data-url="{{route('sistema.dash.vendedor.rfq.mensagens', [$resposta->mensagem ?? 0])}}">
