        ...
        <div class="row">     
          <div class="col-lg-3 text-center coluna-usuarios-mensagem lista-mensagens">
            ...
            <div class="row padding-top-15 padding-left-20 barra-search">
              ...
              <button><img src="{{assets('sistema/images/search.png')}}"/></button>
            </div>
            @forelse( $mensagens as $mensagem)
              <div class="row padding-top-30 padding-bottom-30 padding-left-20 linha-usuario-mensagem mensagem" data-id="#{{$mensagem->id}}" id="{{$mensagem->id}}" data-url="{{route('sistema.dash.vendedor.mensagens.mensagem', $mensagem->id)}}">                            
                <div class="col-xs-9 col-sm-9 col-lg-9 col-lg-9">
                  <div class="row">    
                    ...
                    <div class="col-xs-9 col-sm-9 col-lg-9 col-lg-9 text-left padding-left-15">
                      <div class="row">
                        <p>{{$mensagem->usuarioOrigem->fullName}}</p>  
                      </div>
                      <div class="row margin-top-5">
                        <p class="text-navy medium">{{$mensagem->usuarioOrigem->empresa->nome}}</p>
                      </div>
                      <div class="row">
                ...
                <div class="col-xs-3 col-sm-3 col-lg-3 col-lg-3 padding-top-5 icones text-left">
                  <img src="{{$mensagem->usuarioOrigem->empresa->plano->icone}}" width="30px"/>
                </div>                                                        
              </div>
            @empty
              <div class="alert alert-danger">Nenhuma mensagem recebida ainda!</div>
            @endforelse
