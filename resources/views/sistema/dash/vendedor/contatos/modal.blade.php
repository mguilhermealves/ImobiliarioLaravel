...
<section class="contatos" style="background-color: #fff">
                  ...
                  <div class="flip">
                    <div class="front">
                      <div class="card padding-10">
                        ...
                        <div class="row margin-top-10">
                          <button class="btn btn-sm btn-primary text-12-pt btn-nova" data-toggle="tooltip" data-modal=true data-url="{{route('sistema.dash.contato.novamensagem', $contato->id)}}" title="Nova Mensagem" data-id="{{$contato->id}}">
