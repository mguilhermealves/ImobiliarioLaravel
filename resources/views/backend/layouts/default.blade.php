...
<html lang="{{ app()->getLocale() }}">
    <head>
        ...
        <link rel="stylesheet" href="{{assets('backend/bower_components/bootstrap-colorpicker/dist/css/bootstrap-colorpicker.min.css')}}">
        ...
        <link rel="stylesheet" href="{{assets('backend/bower_components/datatables.net-bs/css/dataTables.buttons.min.css')}}">
        <link rel="stylesheet" href="{{assets('backend/bower_components/datatables.net-bs/css/dataTables.buttons.bootstrap.min.css')}}">
        <link rel="stylesheet" href="{{assets('node_modules/sweetalert2/dist/sweetalert2.css')}}">
        <link rel="stylesheet" href="{{assets('backend/bower_components/select2/dist/css/select2.min.css')}}">
        <link rel="stylesheet" href="{{assets('backend/bower_components/bootstrap-toggle/css/bootstrap-toggle.min.css')}}">
...
<script src="{{assets('backend/bower_components/raphael/raphael.min.js')}}"></script>
<script src="{{assets('backend/bower_components/morris.js/morris.min.js')}}"></script>
<script src="{{assets('backend/bower_components/jquery-sparkline/dist/jquery.sparkline.min.js')}}"></script>
...
<script src="{{assets('backend/bower_components/jquery-knob/dist/jquery.knob.min.js')}}"></script>
...
<script src="{{assets('backend/bower_components/bootstrap-colorpicker/dist/js/bootstrap-colorpicker.min.js')}}"></script>
...
<script src="{{assets('backend/bower_components/datatables.net-bs/js/dataTables.buttons.min.js')}}"></script>
<script src="{{assets('backend/bower_components/datatables.net-bs/js/dataTables.buttons.bootstrap.min.js')}}"></script>
...
<script src="{{assets('backend/bower_components/bootstrap-toggle/js/bootstrap-toggle.min.js')}}"></script>
